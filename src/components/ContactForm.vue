    ...
    <div id="contact" class="flex justify-center py-10 bg-blue-100 ">
        <div class="bg-navyblue w-[90vw] sm:w-[70vw] lg:w-[40vw] rounded-xl">
            ...
            <div class="text-center">
                ...
                <input type="text" id="name" name="name" placeholder="Name" autocomplete="off" class="w-[75vw] sm:w-[55vw] lg:w-[35vw] p-1 pl-3 mt-6 rounded-md bg-slate-300 focus:bg-slate-100 outline-0">
            </div>
            <div class="text-center">
            ...
            <div class="text-center">
                <textarea type="text" id="message" name="message" placeholder="Message" autocomplete="off" class="w-[75vw] sm:w-[55vw] h-40 lg:w-[35vw] p-1 pl-3 mt-6 outline-0 rounded-md bg-slate-300 focus:bg-slate-100"></textarea>
